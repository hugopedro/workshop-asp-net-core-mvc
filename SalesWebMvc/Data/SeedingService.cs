...
using SalesWebMvc.Models; // está em outra pasta por isso
...
namespace SalesWebMvc.Data
{
    ...
    {
        //montando a injeção de dependencia
        ...
        public void Seed() // esse método/SERVIÇO é responsável por popular a base de dados!!!!
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1); // departamento d1, tá havendo uma associação entre objetos 
